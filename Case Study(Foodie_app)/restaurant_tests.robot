...
Register Restaurant
    ...
    ${body}=    Create Dictionary    name=Food Hub    category=Veg    location=Delhi    images=${images}    contact=9999999999
...
Add Dish
    ${body}=    Create Dictionary    name=Pizza    type=Veg    price=250    available_time=10AM-10PM    image=pizza.jpg
...
Register User
    ${body}=    Create Dictionary    name=Harsh    email=harsh@test.com    password=123456
